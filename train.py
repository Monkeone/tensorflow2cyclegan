...
if __name__ == '__main__':
    ...
    discA.compile(optimizer=train_optimizer,loss='mse', metrics= ['accuracy'])
    discB.compile(optimizer=train_optimizer,loss='mse', metrics= ['accuracy'])
    ...
    for epoch in range(epochs):
        ...
        for index in range(num_batches):#num_batches
        ...
        if epoch % save_epoch_freq == 0:
            ...
            genA2B.save('weight\generatorAToB_temp_%d.h5'%epoch)
            genB2A.save('weight\generatorBToA_temp_%d.h5'%epoch)
            discA.save('weight\discriminatorA_temp_%d.h5'%epoch)
            discB.save('weight\discriminatorB_temp_%d.h5'%epoch)
    ...
    genA2B.save('weight\generatorAToB.h5')
    genB2A.save('weight\generatorBToA.h5')
    discA.save('weight\discriminatorA.h5')
    discB.save('weight\discriminatorB.h5')
